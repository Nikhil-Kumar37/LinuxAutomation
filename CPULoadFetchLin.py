...
try:                                
        ...
        #command2 = "ps -eo pid,ppid,cmd,%mem,%cpu --sort=-%cpu | head -11"
        ...
        if any("bash" in s for s in error1):
            output = {"retCode" : "0", "retDesc" : "CPU utilisation Checked Successfully", "CPUUtilisation" : error1}
            write_log(1, "Script Execution Failed")
            print (output)
        else:
            output = {"retCode" : "0", "retDesc" : "CPU utilisation Checked Successfully", "CPUUtilisation" : output1}
            write_log(1, "CPU utilisation Checked Successfully")
            print (output)
        #exit_script(5,"CPU utilisation Checked Successfully", output)
        dssh.close()
